...
describe 'Brand', ->
  ...
  describe ".totalActions", ->
    it "returns the total number of actions across all brands by default", ->
      one   = Brand.create(id: 12345, crowd_participant: true, actions_new: 1)
      two   = Brand.create(id: 12346, crowd_participant: true, actions_new: 2)
      three = Brand.create(id: 12347, crowd_participant: false, actions_new: 3)
      expect(Brand.totalActions()).toEqual(6)

    it "returns the total number of actions across a myBrands or newBrands", ->
      one   = Brand.create(id: 12345, crowd_participant: true, actions_new: 1)
      two   = Brand.create(id: 12346, crowd_participant: true, actions_new: 2)
      three = Brand.create(id: 12347, crowd_participant: false, actions_new: 4)
